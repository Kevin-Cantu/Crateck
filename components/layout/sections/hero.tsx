    ...
    >
      ...
      <div className="relative z-10 w-full h-full flex">
        ...
        <div className="flex-1 flex flex-col justify-center px-6 lg:px-12 xl:px-16 py-8">
          ...
          <div
            className={`transform transition-all duration-700  mt-8 delay-100 ${
              isVisible
          ...
          {/* Descripción */}
          <div
            className={`transform transition-all mt-8 sm:mt-0 duration-700 delay-200 ${
              isVisible
                ? "translate-x-0 opacity-100"
                : "-translate-x-10 opacity-0"
            }`}
          >
            ...
            <p className="text-base md:text-lg text-gray-300/90 mb-6 leading-relaxed max-w-2xl mt-12 sm:block hidden">
              Desarrollo integral de ingeniería, obra civil y eléctrica.
              Especialistas en instalaciones BT/MT, subestaciones, alumbrado
          ...
          {/* Botones */}
          <div
            className={`transform transition-all  sm:-mt-0  mt-8 duration-700 delay-400 ${
              isVisible
                ? "translate-x-0 opacity-100"
                : "-translate-x-10 opacity-0"
            }`}
